...
- [A necessidade de uma `trie`](/chapters/ch06.4-the-need-for-a-trie.md)
  - [Afinal, o que é uma `Trie`?](/chapters/ch06.4-the-need-for-a-trie.md#what-is-a-trie-anyway)
- [Exercício 1 - Implementando uma `Trie`](/chapters/ch07-ex-implementing-a-trie.md#exercise-1---implementing-a-trie)
  ...
  - [Desafio 1: Basic Trie with `insert` Method](/chapters/ch07-ex-implementing-a-trie.md#challenge-1-basic-trie-with-insert-method)
  ...
  - [Desafio 2: Implement `search` method](/chapters/ch07-ex-implementing-a-trie.md#challenge-2-implement-search-method)
...
- [Exercise 2 - Implementing our Trie based `Router`](/chapters/ch08-ex-implementing-router.md#exercise-2---implementing-our-trie-based-router)
  - [Desafio 1: Implementing the `addRoute` method](/chapters/ch08-ex-implementing-router.md#challenge-1-implementing-the-addroute-method)
  ...
  - [Desafio 2: Implementing the `findRoute` method](/chapters/ch08-ex-implementing-router.md#challenge-2-implementing-the-findroute-method)
