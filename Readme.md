...
- [Ex. Query parameters (Advanced)](chapters/ch06.12.query-parameters.md#ex-query-parameters-advanced-)
  - [Introduction to Query Parameters](chapters/ch06.12.query-parameters.md#introduction-to-query-parameters)
  - [Anatomy of a URL with Query Parameters](chapters/ch06.12.query-parameters.md#anatomy-of-a-url-with-query-parameters)
    - [Key Components of Query Parameters](chapters/ch06.12.query-parameters.md#key-components-of-query-parameters)
  - [Challenge 1: Implementing Basic Query Parameter Parsing](chapters/ch06.12.query-parameters.md#challenge-1-implementing-basic-query-parameter-parsing)
    - [Requirements](chapters/ch06.12.query-parameters.md#requirements)
    - [Hints](chapters/ch06.12.query-parameters.md#hints)
    - [Expected Outcome](chapters/ch06.12.query-parameters.md#expected-outcome)
    - [A quick heads up](chapters/ch06.12.query-parameters.md#a-quick-heads-up)
    - [Example](chapters/ch06.12.query-parameters.md#example)
    - [Solution](chapters/ch06.12.query-parameters.md#solution)
    - [Explanation](chapters/ch06.12.query-parameters.md#explanation)
    - [Let's test our implementation](chapters/ch06.12.query-parameters.md#let-s-test-our-implementation)
  ...
  - [Benchmarks](chapters/ch06.12.query-parameters.md#benchmarks)
    - [Explanation](chapters/ch06.12.query-parameters.md#explanation)
    - [Explanation of `#parseQueryParams`](chapters/ch06.12.query-parameters.md#explanation-of-parsequeryparams-)
    - [Conclusion](chapters/ch06.12.query-parameters.md#conclusion)
