...
-   [HTTP Verbs, Versioning and the benefits of `HTTP/1.1`](/chapters/ch06.1-http-verbs-versioning-http1_1.md)
    ...
    -   [`HTTP/1.0`](/chapters/ch06.1-http-verbs-versioning-http1_1.md#http10)
        ...
        -   [Versioning](/chapters/ch06.1-http-verbs-versioning-http1_1.md#versioning)
        -   [Status Codes](/chapters/ch06.1-http-verbs-versioning-http1_1.md#status-codes)
        -   [Content-Type Header](/chapters/ch06.1-http-verbs-versioning-http1_1.md#content-type-header)
        -   [New Methods](/chapters/ch06.1-http-verbs-versioning-http1_1.md#new-methods)
    -   [`HTTP/1.1`](/chapters/ch06.1-http-verbs-versioning-http1_1.md#http11)
        -   [Persistent Connections](/chapters/ch06.1-http-verbs-versioning-http1_1.md#persistent-connections)
        -   [Pipelining](/chapters/ch06.1-http-verbs-versioning-http1_1.md#pipelining)
        -   [Chunked Transfer Encoding](/chapters/ch06.1-http-verbs-versioning-http1_1.md#chunked-transfer-encoding)
        -   [The `Host` header](/chapters/ch06.1-http-verbs-versioning-http1_1.md#the-host-header)
        -   [Caching improvements](/chapters/ch06.1-http-verbs-versioning-http1_1.md#caching-improvements)
        -   [Range Requests](/chapters/ch06.1-http-verbs-versioning-http1_1.md#range-requests)
...
-   [MIME Type and `Content-Type`](/chapters/ch06.3-mime-type-and-content-type.md#mime-type-and--content-type-)
    ...
    -   [The `charset=UTF-8`: character encoding](/chapters/ch06.3-mime-type-and-content-type.md#the-charsetutf-8-character-encoding)
        -   [Universal Character Encoding](/chapters/ch06.3-mime-type-and-content-type.md#universal-character-encoding)
-   [Headers](/chapters/ch06.4-headers.md#headers)
    -   [Header Name](/chapters/ch06.4-headers.md#header-name)
    -   [Colon (`:`)](/chapters/ch06.4-headers.md#colon)
    -   [Header Value](/chapters/ch06.4-headers.md#header-value)
    -   [Whitespace](/chapters/ch06.4-headers.md#whitespace)
    -   [Custom `X-` based headers](/chapters/ch06.4-headers.md#custom-x--based-headers)
-   [Request headers](/chapters/ch06.4-headers.md#request-headers)
    -   [Accept](/chapters/ch06.4-headers.md#accept)
    -   [Referer](/chapters/ch06.4-headers.md#referer)
    -   [Authorization](/chapters/ch06.4-headers.md#authorization)
    -   [Cookie](/chapters/ch06.4-headers.md#cookie)
