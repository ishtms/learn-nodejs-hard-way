...
> The code for the entire section can be found [at the code/chapter_04.1 directory](/code/chapter_04.1/README.md)

# Refactoring the code

In this section, we will explore how to improve the organization and maintenance of our library before introducing more features. Currently, all the code is in one file called **`index.js`**. `index.js` also serves as the entry point of our project. We will show how to move the code to multiple files without changing how it works.
