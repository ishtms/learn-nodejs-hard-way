...
<!--We'll explore the basics of web servers and HTTP in this lesson, and what importance it serves in order to server applications with Nodejs. What parts make up a web server? How do web servers and computers communicate? Let's find out!-->
...
Imagine you're at home, sitting in front of your computer, and you decide to visit a website, let's say "cachelane.com." This simple action initiates a series of events that highlight the "Asking and Getting" process in web communication.

### The Request:

#### Your Request:

You type "cachelane.com" into your browser's address bar and hit Enter. This is like you telling your computer, "Hey, I want to see what's on this website!"

#### Finding the Address:

Your computer knows the basics of websites, but it needs the exact address of "cachelane.com" to connect to it. So, it reaches out to a special helper called a [DNS resolver](https://en.wikipedia.org/wiki/Domain_Name_System#Address_resolution_mechanism).

#### Resolving the Address:

The DNS resolver is like a digital address book. It takes "cachelane.com" and looks up the actual IP address associated with it. This IP address is like the specific coordinates of the website's location on the internet.
...
The DNS resolver finds the IP address linked to "cachelane.com" and sends it back to your computer. It's like the DNS resolver telling your computer, "The website is located at this IP address."
...
The web server receives your request and understands that you want to see the content of "cachelane.com." It then gathers the necessary files – HTML, images, stylesheets, scripts – to create the webpage.
...
[![Read Next](/assets/imgs/next.png)](/chapters/ch02.0-your-first-nodejs-program.md)
